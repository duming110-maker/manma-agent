...
export function BcShellFrame({ useSessions, useWorkspaces, useLocale, setLocale, setTheme: setOfficialTheme, newSession, archiveSession, renameSession, listSessionSkills, installSkill, installMarketSkill, listMarketSkills, listCronTasks, createCronTask, updateCronTask, deleteCronTask, runCronTask, listCronRuns, listCronTemplates, listModels, listInstalledSkills, uninstallSkill, editSkill, moveSkill, copySkill, listWorkspaces, listRules, createRule, updateRule, deleteRule, listMemories, getMemoriesState, setMemoriesState, createMemory, updateMemory, deleteMemory, pickWorkspaceDirectory, openPath, listOpenWithOptions, setDefaultOpen, openEditor, t, renderSlot }: BcShellFrameProps) {
  ...
  const upstream = useMemo<UpstreamFace>(() => ({
    newSession, archiveSession, renameSession, listSessionSkills, setLocale, setTheme: setOfficialTheme, pickWorkspaceDirectory, openPath, listOpenWithOptions, setDefaultOpen, openEditor, installSkill, installMarketSkill, listMarketSkills, listCronTasks, createCronTask, updateCronTask, deleteCronTask, runCronTask, listCronRuns, listCronTemplates, listModels, listInstalledSkills, uninstallSkill, editSkill, moveSkill, copySkill, listWorkspaces, listRules, createRule, updateRule, deleteRule, listMemories, getMemoriesState, setMemoriesState, createMemory, updateMemory, deleteMemory,
  }), [newSession, archiveSession, renameSession, listSessionSkills, setLocale, setOfficialTheme, pickWorkspaceDirectory, openPath, listOpenWithOptions, setDefaultOpen, openEditor, installSkill, installMarketSkill, listMarketSkills, listCronTasks, createCronTask, updateCronTask, deleteCronTask, runCronTask, listCronRuns, listCronTemplates, listModels, listInstalledSkills, uninstallSkill, editSkill, moveSkill, copySkill, listWorkspaces, listRules, createRule, updateRule, deleteRule, listMemories, getMemoriesState, setMemoriesState, createMemory, updateMemory, deleteMemory])
