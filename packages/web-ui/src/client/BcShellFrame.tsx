 ...
 */
export function BcShellFrame({ useSessions, useWorkspaces, useLocale, setLocale, setTheme: setOfficialTheme, newSession, archiveSession, renameSession, listSessionSkills, installSkill, listCronTasks, createCronTask, updateCronTask, deleteCronTask, runCronTask, listCronRuns, listModels, listInstalledSkills, uninstallSkill, editSkill, pickWorkspaceDirectory, t, renderSlot }: BcShellFrameProps) {
  ...
  const upstream = useMemo<UpstreamFace>(() => ({
    newSession, archiveSession, renameSession, listSessionSkills, setLocale, setTheme: setOfficialTheme, pickWorkspaceDirectory, installSkill, listCronTasks, createCronTask, updateCronTask, deleteCronTask, runCronTask, listCronRuns, listModels, listInstalledSkills, uninstallSkill, editSkill,
  }), [newSession, archiveSession, renameSession, listSessionSkills, setLocale, setOfficialTheme, pickWorkspaceDirectory, installSkill, listCronTasks, createCronTask, updateCronTask, deleteCronTask, runCronTask, listCronRuns, listModels, listInstalledSkills, uninstallSkill, editSkill])
